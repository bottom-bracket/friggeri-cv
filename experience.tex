...
\begin{entrylist}
  \entry
    ...
    \begin{itemize}
      ...
      \item Collaborated closely with the IT group to ensure internal database integrity across Oracle databases and SAS data retrievals, as well as nation-wide deployment of various data query web applications.
